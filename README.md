...
[image]: https://github.com/asaini-tech/ayansaini-cropclass/blob/main/images/Picture1.jpg

Figure 1: Confusion Matrix for the Testing Data

+-------+-------+-------+-------+-------+-------+-------+-------+-------+
|       | Appl  | Apple | Corn  | Po    | Po    | To    | Toma  | To    |
|       | e\_\_ | \_\_C | \_\_C | tato\ | tato\ | mato\ | to\_\ | mato\ |
|       | Apple | edar_ | ommon | _\_Ea | _\_he | _\_Ea | _Toma | _\_he |
|       | _scab | apple | _rust | rly_b | althy | rly_b | to_Ye | althy |
|       |       | _rust |       | light |       | light | llow_ |       |
|       |       |       |       |       |       |       | Leaf_ |       |
|       |       |       |       |       |       |       | Curl_ |       |
|       |       |       |       |       |       |       | Virus |       |
+=======+=======+=======+=======+=======+=======+=======+=======+=======+
| False | 0.18% | 0     | 0     | 0.12% | 0.12% | 0.97% | 0.06% | 7.79% |
| Pos   |       |       |       | (2)   |       |       |       |       |
| itive | \(3\) |       |       |       | \(2\) | \     | \(1\) | \(    |
|       |       |       |       |       |       | (16\) |       | 129\) |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| False | 0.36% | 0.72% | 0     | 0.06% | 7.79% | 0.06% | 0.06% | 0.18% |
| Neg   |       | (12)  |       |       |       |       |       |       |
| ative | \(6\) |       |       | \(1\) | \(1\) | \(1\) | \(1\) | \(3\) |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| True  | 1     | 1     | 1     | 1     | 9.66% | 1     | 1     | 3.20% |
| Pos   | 6.24% | 0.39% | 7.57% | 0.93% |       | 1.11% | 1.65% |       |
| itive | (269) | (172) | (291) | (181) | \(    |       |       | \     |
|       |       |       |       |       | 160\) | \(    | \(    | (53\) |
|       |       |       |       |       |       | 184\) | 193\) |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| True  | 8     | 9     | 8     | 9     | 8     | 8     | 8     | 8     |
| Neg   | 4.36% | 0.04% | 3.57% | 0.04% | 3.57% | 9.01% | 9.37% | 9.98% |
| ative | (     | (     | (     | (     |       |       |       |       |
|       | 1397) | 1491) | 1384) | 1491) | \(1   | \(1   | 1480  | 1490  |
|       |       |       |       |       | 384\) | 474\) |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| Prec  | 0.989 | 1.000 | 1.000 | 0.989 | 0.988 | 0.920 | 0.995 | 0.291 |
| ision |       |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| R     | 0.978 | 0.935 | 1.000 | 0.995 | 0.554 | 0.995 | 0.995 | 0.946 |
| ecall |       |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| F1    | 0.983 | 0.966 | 1.000 | 0.992 | 0.711 | 0.956 | 0.995 | 0.445 |
| Score |       |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| Total | 275   | 184   | 291   | 182   | 289   | 185   | 194   | 56    |
| S     |       |       |       |       |       |       |       |       |
| ample |       |       |       |       |       |       |       |       |
| Size  |       |       |       |       |       |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
